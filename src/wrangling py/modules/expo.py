...
# %%
df_grafico1_tabla = pd.read_excel("./src/wrangling py/data/ICA_esqueleto.xlsx", sheet_name="graf1 expo.rubros.",skipfooter=1,skiprows=1)
df_grafico1_tabla
...
cuadro5 = pd.read_excel("./src/wrangling py/data/ICA_esqueleto.xlsx", sheet_name="c5",skipfooter=0,skiprows=4,names=columnas)
cuadro5.head()

# %%
cuadro6 = pd.read_excel("./src/wrangling py/data/ICA_esqueleto.xlsx", sheet_name="c6",skipfooter=0,skiprows=3)[1:]
