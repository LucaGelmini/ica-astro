...
df_grafico2_tabla = pd.read_excel(
    f"{DIR}ICA_esqueleto.xlsx", sheet_name="graf2 impo.usos.", skiprows=1)
...
cuadro7 = pd.read_excel(
    f"{DIR}ICA_esqueleto.xlsx", sheet_name="c7", skiprows=4)[1:]
cuadro7.head()

# %%
cuadro8 = pd.read_excel(
    f"{DIR}ICA_esqueleto.xlsx", sheet_name="c8", skiprows=3)[1:]
